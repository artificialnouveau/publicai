...
| Path | What it is |
| --- | --- |
| [`sideprojects/airbus-for-ai/`](sideprojects/airbus-for-ai/) | A near-future scenario, 11 chapters across 5 capitals, that traces what an "Airbus for AI" coalition would look like. Built from the Bennett School brief (Tan, Jackson, Berjon, Coyle, Sept 2025). Includes 11 live-data charts and an interactive coalition designer. |
...
- `http://localhost:8000/sideprojects/airbus-for-ai/` (the story + interactive designer)
